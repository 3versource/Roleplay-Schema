...
function PLUGIN.Ops.EventManager.SequenceLoad(path)
	...
	PLUGIN.Ops.EventManager.Sequences[json.Name] = json

	return true
end

function PLUGIN.Ops.EventManager.SequenceSave(name)
...
function PLUGIN.Ops.EventManager.SequencePush(name)
	local sequence = PLUGIN.Ops.EventManager.Sequences[name]
...
function PLUGIN.Ops.EventManager.GetVersionHash()
	return util.CRC(util.TableToJSON(PLUGIN.Ops.EventManager.Config.Events))
end